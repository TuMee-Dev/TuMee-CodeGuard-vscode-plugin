/**
 * Tree-sitter based scope resolution for guard tags
 * Handles scope boundary detection using abstract syntax trees
 */

import type * as vscode from 'vscode';
import { GUARD_TAG_PREFIX } from './regexCache';
import { parseDocument, findNodeAtPosition, findParentOfType, getNodeBoundaries } from './treeSitterParser';
 ...
 */
export async function resolveSemanticWithTreeSitter(
 ...
 */
export function findSignatureScopeTreeSitter(
  node: Node,
  nodeTypes: string[],
  _guardLine: number
): ScopeBoundary | null {
 ...
 */
export function findBodyScopeTreeSitter(
  node: Node,
  nodeTypes: string[]
): ScopeBoundary | null {
 ...
 */
export function findStatementScopeTreeSitter(
  node: Node,
  line: number
): ScopeBoundary | null {
 ...
 */
export function findContextScopeTreeSitter(
  tree: Tree,
  line: number,
  document: vscode.TextDocument
): ScopeBoundary | null {
